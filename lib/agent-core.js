...
- The result uses the correct sign convention from the canonical CSV: revenue is positive,
  ...
  £ amounts (e.g. "Overheads: £4,200") — do not show a minus sign for normal costs.
...
- Mention excluded items briefly (e.g. "£X of balance-sheet movements — transfers, VAT, etc. —
    ...
    input_schema: {
      ...
      properties: {
        ...
        filter: {
          type: 'string',
          description:
            'Optional: filter expression like "category=Groceries" or "month=June"',
        },
      },
    ...
    input_schema: {
      ...
      properties: {
        ...
        filter: {
          type: 'string',
          description:
            'Optional row filter, e.g. "month=May" or "category=Overheads". ' +
